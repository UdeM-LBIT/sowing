...
from sowphy.supertree import Triple, Fan, breakup, build, supertree
...
def test_breakup():
    ...
    assert breakup(
        Node()
        .add(Node()
             .add(Node().add(Node("d")).add(Node("e")))
             .add(Node("f"))
        )
        .add(Node()
             .add(Node("h"))
    ...
    assert breakup(
        Node()
        .add(Node().add(Node().add(Node("b")).add(Node("c"))))
        .add(Node("a"))
    ) == ([
    ...
    assert breakup(
        Node()
        .add(Node("b")).add(Node("c")).add(Node("d"))
    ) == ([
